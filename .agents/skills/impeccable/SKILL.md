...
- **Neobrutalism & Hard Drop Shadows.** No `border-[2px]` paired with `shadow-[4px_4px_0px_#111]`. The user has EXPLICITLY BANNED "brutal laserism" / neobrutalist aesthetic. Maintain the sophisticated, editorial, flat "New Yorker" aesthetic instead. No harsh blocky offset shadows.
