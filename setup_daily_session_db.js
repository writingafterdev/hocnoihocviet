...
async function setup() {
  ...
  try {
    ...
    await databases.createStringAttribute(dbId, qColId, 'prompt', 10000, true);
    await databases.createStringAttribute(dbId, qColId, 'options', 1000, false, null, true); // Array
    await databases.createStringAttribute(dbId, qColId, 'correct_answer', 1000, true);
    await databases.createStringAttribute(dbId, qColId, 'explanation', 10000, false);
    ...
    await databases.createStringAttribute(dbId, pColId, 'context', 10000, true);
